 ...
 * available routes. Each path has four different tickets train, bus, taxi and
 * boat. the stations are storeed in a json file which IO class reads that and
 * return the station with exact positions and tickets. This also checks if two
 * stations are neighbors or not.
 *
 * @author kobra
 */
public class Board {
